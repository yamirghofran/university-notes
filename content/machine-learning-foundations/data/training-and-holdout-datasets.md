...
### Validation Set
Used to select the learning algorithm and find the best configuration value for that model (called [Hyperparameter](/machine-learning-foundations/introduction/parameters-and-hyperparameters)).
