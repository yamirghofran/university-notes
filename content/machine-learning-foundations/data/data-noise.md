...
If [tidy data](/machine-learning-foundations/data/raw-and-tidy-data) has missing attributes, [Data Imputation](/machine-learning-foundations/data/data-imputation) techniques can help fill in those missing values.

Blurred images can be de-blurred using specific image de-blurring algorithms, though deep machine learning models like [Neural Networks](/machine-learning-foundations/deep-learning/neural-networks) can learn to de-blur if needed.
