...
#ml/algorithms
The k-nearest neighbors (KNN) algorithm is a simple, intuitive, and widely used machine learning algorithm for #ml/classification and #ml/regression tasks. It is a type of [Instance-Based](/machine-learning-foundations/introduction/model-based-vs-instance-based-learning) learning (or lazy learning), meaning it does not explicitly learn a model during training but instead stores the entire dataset and makes predictions based on similarity measures at inference time.
...
- Sensitive to irrelevant or redundant [Feature](/machine-learning-foundations/feature-engineering/feature-vector)s (noise).
