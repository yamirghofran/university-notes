...
A generalization of applying [One-Hot Encoding](/machine-learning-foundations/feature-engineering/one-hot-encoding) to text data. You use it to represent an entire text document as a binary vector.

![](/machine-learning-foundations/attachments/cleanshot-2025-01-21-at-1051372x.png)

First, we have to [tokenize](/machine-learning-foundations/algorithms/tokenization) the texts.
![](/machine-learning-foundations/attachments/cleanshot-2025-01-21-at-1054232x.png)

Next step is to build a vocabulary. It contains 16 tokens:
![](/machine-learning-foundations/attachments/cleanshot-2025-01-21-at-1054512x.png)

Then, we order the vocabulary in some way and assign a unique index to each one.
![](/machine-learning-foundations/attachments/cleanshot-2025-01-21-at-1055272x.png)

We transform our collection into a collection of binary feature vectors:
![](/machine-learning-foundations/attachments/cleanshot-2025-01-21-at-1056012x.png)
