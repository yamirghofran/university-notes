...
Transforming raw data into tidy data ([Raw and Tidy Data](/machine-learning-foundations/data/raw-and-tidy-data)), i.e. into a [Feature Vector](/machine-learning-foundations/feature-engineering/feature-vector).
Fundamental part of ML Engineering. 

Algorithm-specific formatting of feature vectors. e.g. transforming categorical attributes into numerical features with certain [properties](/machine-learning-foundations/feature-engineering/properties-of-good-features) .

Feature engineering is a process of first conceptually and then programmatically transforming a raw example into a [Feature Vector](/machine-learning-foundations/feature-engineering/feature-vector). It consists of conceptualizing a feature and then writing the programming code that would transform the entire raw example, with potentially some help of some indirect data, into a feature.

For feature engineering with text, you can use feature engineering techniques like [One-Hot Encoding](/machine-learning-foundations/feature-engineering/one-hot-encoding) and [Bag of Words](/machine-learning-foundations/feature-engineering/bag-of-words).

There are other **encoding** techniques as well:
- [Mean Encoding](/machine-learning-foundations/feature-engineering/mean-encoding)
- [Feature Hashing](/machine-learning-foundations/feature-engineering/feature-hashing)
- [Topic Modelling](/machine-learning-foundations/algorithms/topic-modelling)
...
  - [Feature Hashing](/machine-learning-foundations/feature-engineering/feature-hashing): Slide 21, Lecture 4.
...
-  **Select features only when necessary:** reasons to do it:
  ...
  - We expect a significant [Distribution Shift](/machine-learning-foundations/data/distribution-shift) between two model trainings.
-  **Test the code carefully:**
  ...
  - Don’t fail silently.
-  **Keep code, model, and data in sync:** [version](/machine-learning-foundations/data/storing-data) must be the same.
...
---
- [Storing and Documenting Features](/machine-learning-foundations/feature-engineering/storing-and-documenting-features)
- [Synthesizing Features](/machine-learning-foundations/feature-engineering/synthesizing-features)
- [Feature Selection](/machine-learning-foundations/feature-engineering/feature-selection)